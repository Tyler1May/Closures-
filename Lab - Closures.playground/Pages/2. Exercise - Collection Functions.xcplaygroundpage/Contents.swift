...
var nameArray: [String] = ["Tyler", "Everett", "John", "Howard", "Archibald"]
var sortedCollection1: [String] = nameArray.sorted(by: forwards)
...
var sortedCollection2: [String] = nameArray.sorted(by: sortingClosure)
...
var sortedCollection3 = nameArray.sorted(by: <)
